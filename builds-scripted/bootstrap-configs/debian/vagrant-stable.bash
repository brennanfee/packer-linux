...
#
# Short URL: https://tinyurl.com/deb-vagrant-stable
# Github URL: https://raw.githubusercontent.com/brennanfee/linux-bootstraps-my-configs/main/scripted-installer/debian/vagrant-stable.bash
#
#
##################  MODIFY THIS SECTION
