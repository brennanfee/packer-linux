...
#
# Short URL: https://tinyurl.com/ubuntu-vm-lts
# Github URL: https://raw.githubusercontent.com/brennanfee/linux-bootstraps-my-configs/main/scripted-installer/ubuntu/vm-lts.bash
#
#
##################  MODIFY THIS SECTION
