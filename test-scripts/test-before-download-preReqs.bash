...
echo "BEFORE SCRIPT: This script downloads some files to be used in other params.  It creates a local encryption key and a local 'after' script file for later use by the installer." >> "${LOG}"
